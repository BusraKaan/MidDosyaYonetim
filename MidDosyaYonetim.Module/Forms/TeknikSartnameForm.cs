...
{
    public partial class TeknikSartnameForm : RibbonForm
    {


        IObjectSpace objectSpace;
        DetailView detail;
        public TeknikSartnameForm(IObjectSpace objectSpace, DetailView detail)
        {
            InitializeComponent();
            ...
            if (checked_nodes.Count > 0)
            {
                ...
                foreach (TreeNode node in checked_nodes)
                {
                    ...
                    if (pathItems.Length == 5)
                    {
                        ...
                        SartnameFile filek = detail.CurrentObject as SartnameFile;
                        ...
                        foreach (Urunler satir in liste)
                        {
                            ...
                            TeknikSartname klt = objectSpace.CreateObject<TeknikSartname>();
        ...
        private void TeknikSartnameForm_Load(object sender, EventArgs e)
        {
