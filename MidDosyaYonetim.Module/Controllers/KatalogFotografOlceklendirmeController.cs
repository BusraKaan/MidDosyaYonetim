...
namespace MidDosyaYonetim.Module.Controllers
{
    ...
    public partial class KatalogFotografOlceklendirmeController : ViewController
    {
        public KatalogFotografOlceklendirmeController()
        {
            InitializeComponent();
        ...
        private void KataloglarFotoOlceklendirmeAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            IObjectSpace objectSpace = Application.CreateObjectSpace();
            IList kataloglar = objectSpace.GetObjects(typeof(Kataloglar));

            foreach (Kataloglar item in kataloglar)
            {
