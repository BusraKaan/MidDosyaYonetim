...
namespace MidDosyaYonetim.Module.Controllers
{
    ...
    public partial class AksesuarFotografOlceklendirController : ViewController
    {
        public AksesuarFotografOlceklendirController()
        {
            InitializeComponent();
        ...
        private void AksesuarFotoOlceklendirAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            IObjectSpace objectSpace = Application.CreateObjectSpace();
            IList aksesuar = objectSpace.GetObjects(typeof(Aksesuar));

            foreach (Aksesuar item in aksesuar)
            {
                CriteriaOperator crtiteria = CriteriaOperator.Parse("aksesuar=?", item.Oid);
