...
namespace MidDosyaYonetim.Module.Controllers
{
    ...
    public partial class SertifikaEkle : ViewController
    {
        public SertifikaEkle()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
                ...
                var space = Application.CreateObjectSpace(typeof(SertifikaFile));
                LayoutControl layoutControl = new LayoutControl();
                layoutControl.Dock = System.Windows.Forms.DockStyle.Top;

                Object objectToShow = space.CreateObject(typeof(SertifikaFile));
                DetailView createdView = Application.CreateDetailView(space, objectToShow);
                createdView.ViewEditMode = ViewEditMode.Edit;

                SertifikaEkleForm form = new SertifikaEkleForm(objectSpace, createdView);
