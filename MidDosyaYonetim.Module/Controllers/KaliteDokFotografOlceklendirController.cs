...
namespace MidDosyaYonetim.Module.Controllers
{
    ...
    public partial class KaliteDokFotografOlceklendirController : ViewController
    {
        public KaliteDokFotografOlceklendirController()
        {
            InitializeComponent();
        ...
        private void KaliteDokFotoOlceklendirmeAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            IObjectSpace objectSpace = Application.CreateObjectSpace();
            IList kaliteDok = objectSpace.GetObjects(typeof(KaliteDokumanlari));

            foreach (KaliteDokumanlari item in kaliteDok)
            {
