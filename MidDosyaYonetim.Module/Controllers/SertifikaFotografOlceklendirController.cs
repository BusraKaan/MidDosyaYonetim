...
namespace MidDosyaYonetim.Module.Controllers
{
    ...
    public partial class SertifikaFotografOlceklendirController : ViewController
    {
        public SertifikaFotografOlceklendirController()
        {
            InitializeComponent();
        ...
        private void SerrifikaFotoOlceklendirAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            IObjectSpace objectSpace = Application.CreateObjectSpace();
            IList sertifikalar = objectSpace.GetObjects(typeof(Sertifikalar));

            foreach (Sertifikalar item in sertifikalar)
            {
