...
namespace MidDosyaYonetim.Module.BusinessObjects
{
    ...
    public class aksesuarDeger : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public aksesuarDeger(Session session)
            : base(session)
        {
        }
        ...
        private Degerler _degerler;
        [Association("aksDegerToDegerler")]
        public Degerler degerler
        {
            get { return _degerler; }
            set { SetPropertyValue<Degerler>(nameof(degerler), ref _degerler, value); }
        }
